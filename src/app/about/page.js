  ...
  return (
    <div>
      ...
      <div className="flex justify-center">
        <main className="flex flex-col md:flex-row w-[50vw] h-[75vh]">
          <div className="flex flex-col items-center w-full md:w-1/2 p-10">
            ...
            <div className="mt-10 w-[400px] text-left">
              <p>
          ...
          <div className="flex flex-col w-full md:w-1/2 p-10 space-y-6 leading-relaxed font-light tracking-wide h-full text-right">
            <div>
              <p>
                ...
                more rhythmic electronic music under the <a href="https://on.soundcloud.com/xtKsYu2d8dB79Rdu6" className="underline hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">Cylindric</a> alias.
              </p>
            </div>
            <div>
              <p>
                ...
                sound design to professional, high-quality audio editing, I look forward to <a href="/contact" className="underline hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">any propositions</a>.
              </p>
            </div>
          </div>
        </main>
